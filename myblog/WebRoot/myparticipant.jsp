    ...
    <td width="680" valign="top"><table width="680" border="0" cellpadding="0" cellspacing="1" bgcolor="#dddddd">
      <tr>
        <td align="center" bgcolor="#fcfcfc"><table width="650" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" align="left" class="F12Strong">您参与评论的博文</td>
          </tr>
          <tr>
        ...
        <%User mypart=(User)session.getAttribute("scsLogin");
        if(mypart==null){
        String msg=URLEncoder.encode("您还没有登录","utf-8");
	   response.sendRedirect(request.getContextPath()+"/error.jsp?msg="+msg);
	   return;
        }
         CommentsDao articlesDao=new CommentsDao();
         ArrayList<Articles>list=articlesDao.findArticlesByUserid(mypart.getId());
         if(list.size()!=0){
