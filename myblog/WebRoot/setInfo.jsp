...
<body>
<%
User setuserinfo=(User)session.getAttribute("scsLogin");

String uid=String.valueOf(setuserinfo.getId());
//安全验证
if(uid==null||uid.length()==0)
{String msg=URLEncoder.encode("您还没有登录，请先登录","utf-8");
          ...
          <tr>
            <td><table width="500" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="480" bgcolor="#ddddcc">用户详细信息添加</td>
                ...
                <form id="form2" name="form2" method="post" action="doprocess/doSetInfo.jsp">
                  <table width="250" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><%=tname.getTrueName() %><input type="hidden" name="uid" value="<%=uid%>"/></td>
                    </tr>
                    <tr>
                      ...
                      <%String Mselected="";
                        String Wselected="";
                        if("男".equals(tname.getGender())){
                        Mselected="checked=\"checked\"";
                        }
                        else{
                        Wselected="checked=\"checked\"";
                        }
                       %>
                        <input type="radio" name="gender" value="男" <%=Mselected %>/>
                        男
                        　
                        <input type="radio" name="gender" value="女" <%=Wselected %>/> 
                        女
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input name="mail" type="text" class="inputTextW110H22" /></td>
                    </tr>
                    <tr>
                      <td height="30" align="right">QQ：</td>
                      <td><input name="qq" type="text" class="inputTextW110H22" /></td>
                    </tr>
                    <tr>
