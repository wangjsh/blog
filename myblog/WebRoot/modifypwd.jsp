          ...
          <tr>
            <td><table width="500" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="480" bgcolor="#ddddcc">修改密码</td>
                ...
                <td width="498" height="250" align="center"><form id="form2" name="form2" method="post" action="doprocess/domodify.jsp">
                  <table width="250" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td><input name="pwd" type="password" class="inputTextW110H22" /></td>
                    </tr>
                    <tr>
                      <td height="30" align="right">新密码：</td>
                      <td><input name="pwd1" type="password" class="inputTextW110H22" /></td>
                    </tr>
