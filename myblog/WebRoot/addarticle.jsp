 ...
 <td width="680" valign="top"><table width="680" border="0" cellpadding="0" cellspacing="1" bgcolor="#dddddd">
      <tr>
        <td align="center" bgcolor="#fcfcfc"><table width="650" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" align="left">发表博文</td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="30" align="left"><form id="form2" name="form2" method="post" action="${pageContext.request.contextPath }/doprocess/doAddarticle.jsp">
              <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  
                  <td align="center" colspan="2">博文标题：<input name="title" type="text" class="inputTextW480" /></td>
                ...
                <tr>
                  <td align="right"></td>
                  <td><label>
                    <textarea name="userIntro" rows="20" class="inputTextW480"></textarea>
                     <ckeditor:replace  replace="userIntro" basePath="${pageContext.request.contextPath }/ckeditor" />
                  </label></td>
                </tr>
                <tr>
